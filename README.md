...
- 🎓 Currently focused on web development and exploring new technologies
...
- Exploring real-time communication tools and enhancing database management with *Mongoose* and *Prisma*
...
- Building robust *real-time applications* with modern web tools
